...
def main():
    """
    Main function to encapsulate the advanced version of the number guessing game logic.
    """
    ...
    while play_again.lower() == 'y':
        ...
        # --- Main Game Loop ---
        # A 'for' loop limits the user to a specific number of guesses (5).
        # The range starts at 1 and goes to 6 to give us guess numbers 1 through 5.
        for guess_count in range(1, 6):
            ...
            # If the guess is incorrect but there are tries left.
            else:
